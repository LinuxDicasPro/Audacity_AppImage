...
APP=audacity
BIN="$APP"
DEPENDENCES="alsa-lib chrpath catch2-v2 ffmpeg flac gcc-libs gdk-pixbuf2 glib2 glibc gtk3 gtkmm3 jack lame libid3tag libmad libogg libsbsms libsndfile libsoxr libvorbis libxkbcommon-x11 lilv lv2 mpg123 opusfile portaudio portmidi portsmf rapidjson soundtouch sqlite suil twolame vamp-plugin-sdk vst3sdk wavpack wxwidgets-gtk3 xcb-util xcb-util-cursor xcb-util-keysyms hicolor-icon-theme adwaita-icon-theme shared-mime-info"
...
LIBSAVED="SAVELIBSPLEASE $lib_browser_launcher gdk-pixbuf-2.0"
...
mv ./Audacity-x86_64.AppImage ./Audacity-$VERSION-x86_64.AppImage
